    ...
    <div class="d-flex justify-content-center">
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" action="/employee?action=create"
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="phoneNumber" class="form-control" placeholder="Input Phone number" name="phone">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <select id="educationDegreeId" class="form-control" name="educationDegree">
